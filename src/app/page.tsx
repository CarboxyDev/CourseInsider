    ...
    <PageWrapper>
      <div className="grid place-items-center">
        <h1 className="text-7xl text-center mt-28 text-zinc-800 font-semibold w-2/3">
          ...
          <span className="headline-gradient">Effortlessly</span>
        </h1>
        ...
        <button className="text-2xl mt-16 font-semibold py-4 px-12 bg-sky-400 text-white rounded-lg border border-sky-600 shadow-sm">
          Find Your College
        </button>
        <Image
          src={hero}
